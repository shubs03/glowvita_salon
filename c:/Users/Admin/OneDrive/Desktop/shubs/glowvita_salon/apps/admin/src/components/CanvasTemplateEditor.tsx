...
import type { TEvent, FabricImage, ImageProps, SerializedImageProps, ObjectEvents, TPointerEvent, FabricObject, FabricObjectProps, SerializedObjectProps } from 'fabric';
