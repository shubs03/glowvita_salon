      ...
      <DropdownMenuTrigger asChild>
        ...
        >
          <div className="relative">
            ...
            {unreadCount > 0 && (
              <span className="absolute -top-1 -right-1 h-3.5 w-3.5 bg-primary rounded-full flex items-center justify-center ring-2 ring-background">
      ...
      <DropdownMenuContent align="end" className="w-80 sm:w-96 bg-background/95 backdrop-blur-xl border border-border/30 shadow-2xl rounded-xl p-0 overflow-hidden">
        <DropdownMenuLabel className="p-4 border-b border-border/20">
          <div className="flex items-center justify-between">
            <span className="text-lg font-bold bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">Admin Alerts</span>
            {unreadCount > 0 && (
              <Button 
                variant="ghost" 
                size="sm" 
              ...
              >
                <div className="flex items-start gap-3 w-full">
                  <div className={cn(
                    ...
                    notification.type === 'order' ? "bg-secondary/10" : "bg-muted/20"
                  )}>
