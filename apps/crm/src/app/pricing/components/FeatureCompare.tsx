        ...
        <table className="min-w-full divide-y divide-border">
          <thead className="bg-secondary">
            <tr>
              ...
              <th className="py-3 px-4 text-center text-sm font-medium text-foreground">Enterprise</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-border">
            ...
            <tr className="bg-card hover:bg-accent">
              ...
              <td className="py-3 px-4 text-center text-sm">Premium</td>
            </tr>
            <tr className="bg-background hover:bg-accent">
            ...
            <tr className="bg-background hover:bg-accent">
              <td className="py-3 px-4 text-sm font-medium">Custom Integrations</td>
              <td className="py-3 px-4 text-center text-sm text-muted-foreground">-</td>
              <td className="py-3 px-4 text-center text-sm text-muted-foreground">-</td>
              <td className="py-3 px-4 text-center text-sm">
                <Check className="text-green-500 mx-auto" />
            ...
            <tr className="bg-card hover:bg-accent">
              <td className="py-3 px-4 text-sm font-medium">Dedicated Account Manager</td>
              <td className="py-3 px-4 text-center text-sm text-muted-foreground">-</td>
              <td className="py-3 px-4 text-center text-sm text-muted-foreground">-</td>
              <td className="py-3 px-4 text-center text-sm">
                <Check className="text-green-500 mx-auto" />
