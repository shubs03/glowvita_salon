                ...
                <TableRow key={order._id}>
                  <TableCell className="font-medium py-3 min-w-[120px] max-w-[150px]">
                    <div className="flex items-center gap-3">
                      <span className="font-semibold truncate max-w-[80px]">#{order.orderId || `ONLINE-${order._id.substring(0, 8).toUpperCase()}`}</span>
                    </div>
                  </TableCell>
                  <TableCell className="min-w-[150px] max-w-[180px] truncate">{order.customerName || 
