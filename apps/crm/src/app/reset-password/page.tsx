    ...
    if (!mounted) {
      return (
        <div className="text-center py-8">
          <div className="animate-spin rounded-full h-10 w-10 border-b-2 border-[#422A3C] mx-auto"></div>
      ...
      <>
        <div className="text-center mb-5">
          ...
          <p className="text-gray-600 text-xs px-2">
            Set a strong new password to secure your GlowVita Salon account and continue managing your salon business and appointments.
          </p>
        </div>
          ...
          <div className="space-y-8 relative z-10">
            ...
            <div className="flex items-start gap-2.5">
              ...
              <div>
                ...
                <p className="text-white/80 text-xs mt-0.5">Reset your password and continue managing your salon business with ease.</p>
              </div>
            </div>
          </div>
        </div>
