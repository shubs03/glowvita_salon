    ...
    <PageContainer padding="none">
      ...
      <section className="py-20 md:py-24 text-center bg-secondary/50">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
            Your privacy is important to us. This notice describes how and why we might collect, store, use, and/or share your information at GlowVita CRM.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="privacy-content">
          <p className="lead-text">Last Updated Date: 01/01/2026</p>
          
          <p>
            This privacy notice for <strong>GlowVita CRM</strong> (&apos;<strong>Company</strong>&apos;, &apos;<strong>we</strong>&apos;, &apos;<strong>us</strong>&apos;, or &apos;<strong>our</strong>&apos;), 
          ...
          <ul>
            <li>Download and use our mobile application (GlowVita CRM), or</li>
            ...
            {[
              {
                ...
                answer: "When you visit, use, or navigate our Services, we may process personal information depending on how you interact with GlowVita CRM and the Services, the choices you make, and the products and features you use."
              },
              {
              ...
              },
              {
                ...
                answer: "We process your information to provide, improve, and administer our Services, communicate with you, prevent security and fraud, and comply with the law. We may also process your information for other purposes with your consent."
              },
              {
              ...
              },
              {
                ...
                answer: "We have organisational and technical processes and procedures in place to protect your personal information. However, no electronic transmission over the internet or information storage technology can be guaranteed to be 100% secure."
              },
              {
              ...
              },
              {
                ...
                answer: "The easiest way to exercise your rights is by visiting support@glowvitasalon.com or by contacting us."
              }
            ].map((item, index) => (
              <div key={index}>
          ...
          <div className="toc-box">
            ...
            <ol>
              ...
              <li><a href="#request">HOW CAN YOU REVIEW, UPDATE, OR DELETE DATA?</a></li>
            </ol>
          </div>
          ...
          <p><strong>Application Data.</strong> If you use our application(s), we may also collect the following information if you choose to provide us with access or permission:</p>
          <ul>
          ...
          <p><strong><em>In Short:</em></strong> <em>We process your information to provide, improve, and administer our Services, communicate with you, for security and fraud prevention, and to comply with the law. We may also process your information for other purposes with your consent.</em></p>
          ...
          <p>Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it. To request a review, update, or deletion of your personal information, please contact us at <a href="mailto:support@glowvitasalon.com">support@glowvitasalon.com</a>.</p>
        </div>
      </div>
    </PageContainer>
  );
