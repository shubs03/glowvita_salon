            ...
            <div className="space-y-16 md:space-y-0">
              {[
                ...
                <div key={index} className="relative">
                  <div className="md:grid md:grid-cols-2 md:gap-8 md:items-center md">
                    {/* Step Bubble */}
                    <div
                      className={cn(
                        "hidden md:flex",
                    ...
                    >
                      ...
                      <div className="relative z-10 p-6 rounded-lg bg-background border shadow-lg group hover:border-blue-500/20 hover:shadow-2xl transition-all duration-300">
                        <div
                          className={cn(
                            "absolute top-1/2 -mt-2 w-4 h-4 bg-background border transform rotate-45 z-0",
                            index % 2 === 0
                              ? "md:-right-2 md:border-l-0 md:border-b-0"
                              : "md:-left-2 md:border-r-0 md:border-t-0"
                          )}
                        ></div>
