          ...
          <div className="space-y-8 relative z-10">
            <div className="flex items-start gap-2.5">
              ...
              <div>
                ...
                <p className="text-white/80 text-xs mt-0.5">Securely reset your password and regain access to your salon dashboard.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2.5">
              ...
              <div>
                <h3 className="font-bold text-white text-base leading-tight">Get Back to Dashboard</h3>
                <p className="text-white/80 text-xs mt-0.5">Create a new password and continue managing your business with GlowVita Salon.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex-1 flex flex-col justify-center pb-6">
            <div className="text-center mb-5">
              ...
              <p className="text-gray-600 text-sm">
                We'll help you get back into your account quickly and securely. Reset your password to continue managing your salon business and appointments anytime.
              </p>
            </div>
            ...
            <div className="mt-6 text-center text-sm text-black-600">
              ...
              <Link href="/login" className="font-bold text-[#422A3C] hover:underline">
                Sign in
              </Link>
            </div>
          </div>
