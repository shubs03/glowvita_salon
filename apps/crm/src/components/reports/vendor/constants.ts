  ...
  },
  {
    ...
    reports: [
      ...
      },
      {
        ...
        details: "Shows daily breakdown of total service and product amounts, taxes, platform fees, subscription revenue, SMS purchases, and the combined 'Total Business' figure.",
        points: [
          "Daily Date Breakdown",
          "Service & Product Amounts",
          "Service & Product Taxes",
          "Platform Fees (Service & Product)",
          "Subscription & SMS Revenue",
