    ...
    <div id="invoice-content" className="max-w-4xl mx-auto p-4 sm:p-6 bg-white font-sans print:p-0 print:max-w-none print:w-full rounded-lg print:rounded-none" style={{ minWidth: 'auto' }}>
      ...
      <div className="bg-slate-50 text-slate-900 py-3 px-4 rounded-t-lg -mx-4 sm:-mx-6 -mt-4 sm:-mt-6 mb-4 border-b border-slate-200 print:mx-0 print:mt-0">
        <div className="flex items-center justify-center gap-2">
          <img src="/images/GlowVita%20Salon%20PNG.png" alt="GlowVita Salon" className="h-8 sm:h-10 w-auto object-contain" />
        </div>
      </div>
      ...
      <div className="border-t-2 border-black pt-4 print:pt-4 mt-8 print:mt-4">
        ...
        <div className="mt-6 pt-4 border-t border-gray-300 print:hidden">
          <div className="flex flex-col items-center justify-center gap-2 text-gray-900">
            <span className="font-semibold text-sm text-gray-500">Powered by</span>
            <img src="/images/GlowVita%20Salon%20PNG.png" alt="GlowVita Salon" className="h-8 w-auto object-contain" />
          </div>
          <p className="text-center text-xs text-gray-400 mt-2">www.glowvitasalon.com</p>
        </div>
      </div>
