      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-white">
              ...
              <li className="flex items-center gap-2 group">
                <span className="w-1 h-1 rounded-full bg-white"></span>
                <Link href="#" className="hover:underline transition-all duration-200">Careers</Link>
              </li>
            </ul>
          </div>
          ...
          {/* Column 3: Solutions */}
          <div className="space-y-4">
            <h4 className="font-semibold text-white border-b-2 border-white/30 inline-block pb-1">Solutions</h4>
            <ul className="space-y-2 text-sm text-white">
              <li className="flex items-center gap-2 group">
                <span className="w-1 h-1 rounded-full bg-white"></span>
                <Link href="#" className="hover:underline transition-all duration-200">Salons & Spas</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm text-white">
              <div className="flex items-center gap-2 cursor-pointer">
                ...
                <span>+91 9523641257</span>
              </div>
              <div className="flex items-center gap-2 cursor-pointer">
                <Mail className="w-4 h-4 text-white" />
                <span className="break-all">support@glowvita@gmail.com</span>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-white/10 pt-6 mt-8 flex justify-center items-center">
          <div className="text-center text-white text-sm">
            &copy; 2025 Created by GlowVita Salon | Developed by Paarsh Infotech Pvt. Ltd.
          </div>
        </div>
      </div>
    </footer>
