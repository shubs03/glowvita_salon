...
import { MapPin, Star, Sparkles, TrendingUp, Users, Calendar, Clock, ArrowRight } from 'lucide-react';
...
const AdvantageCard = ({
  ...
  <div className="flex-shrink-0 w-72 md:w-80 h-80 md:h-96 bg-gradient-to-br from-background via-background to-primary/5 rounded-2xl p-6 md:p-8 flex flex-col justify-between relative overflow-hidden group transition-shadow duration-300 border border-border/30 hover:shadow-xl hover:shadow-primary/20">
    <div className="absolute -top-12 -right-12 text-primary/5 text-[140px] md:text-[160px] group-hover:scale-110 transition-transform duration-500">
      {icon}
    </div>
