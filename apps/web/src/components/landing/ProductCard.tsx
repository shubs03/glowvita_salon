          ...
          <div className="absolute top-3 left-3 right-3 flex justify-between items-start z-10">
            ...
            <div className="flex gap-2 ml-auto">
              <button
                ...
                className={cn(
                  "p-2 rounded-full bg-white/20 text-red-500 backdrop-blur-sm transition-all duration-300",
                  isLiked ? "opacity-100" : "opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0"
                )}
              >
