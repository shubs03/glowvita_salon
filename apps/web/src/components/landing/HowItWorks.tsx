    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="relative max-w-5xl mx-auto">
          {/* Connection Lines */}
          <div className="absolute top-16 left-1/2 w-1 h-full bg-gradient-to-b from-primary/20 via-primary/40 to-primary/20 -translate-x-1/2 hidden lg:block"></div>
          ...
          <div className="space-y-16 lg:space-y-20">
            {steps.map((step, index) => (
              <div
                key={index}
                className={cn(
                  "flex flex-col lg:flex-row items-center gap-8 lg:gap-12 transition-all duration-1000",
                  isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0",
              ...
              >
                ...
                <div className="lg:w-1/2 text-center lg:text-left">
                  ...
                  <div className="flex items-center gap-2 mt-4 text-primary font-medium cursor-pointer group">
                    ...
                    <div className="absolute inset-0 pointer-events-none">
                      {[...Array(6)].map((_, i) => (
                        <div
                          key={i}
                          className={cn(
                            "absolute w-1.5 h-1.5 bg-primary/30 rounded-full transition-all duration-1000",
