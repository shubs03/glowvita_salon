...
export function NewProductCard({ 
  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl shadow-lg border border-border/20 bg-card transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10 hover:-translate-y-2">
      {/* Upper Half: Image */}
      ...
      {/* Lower Half: Details */}
      <div className="p-4 flex flex-col justify-between h-[150px] bg-card">
        <div>
        ...
        <div className="mt-auto">
          <div className="flex items-center justify-between mb-3">
             <div className="flex items-center gap-1">
              ...
              <div className="flex items-baseline gap-1.5">
                  ...
                  <span className={cn("font-bold", salePrice ? "text-sm text-muted-foreground line-through" : "text-lg text-foreground")}>
                    ₹{price.toFixed(2)}
                  </span>
              </div>
          </div>
          <Button 
            size="sm" 
            variant="outline" 
            className="w-full rounded-lg group-hover:bg-primary group-hover:text-primary-foreground transition-colors group-hover:border-primary"
