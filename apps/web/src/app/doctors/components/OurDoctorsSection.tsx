...
export function OurDoctorsSection() {
  const doctors = [
    ...
    },
    {
      ...
      rating: 4.8,
      reviews: 980,
      image: "https://placehold.co/300x300/10B981/FFFFFF?text=Dr+Michael",
    ...
    },
    {
      ...
      rating: 4.9,
      reviews: 756,
      image: "https://placehold.co/300x300/8B5CF6/FFFFFF?text=Dr+Emily",
      location: "Chicago, IL",
      languages: ["English", "Spanish"],
    ...
    },
    {
      ...
      rating: 4.7,
      reviews: 1420,
      image: "https://placehold.co/300x300/F97316/FFFFFF?text=Dr+James",
      location: "Boston, MA",
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {doctors.map((doctor) => (
            <div
              key={doctor.id}
              className="group relative bg-white rounded-md border border-border/50 hover:border-primary/20 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 overflow-hidden"
            >
              {/* Doctor Image */}
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute top-3 right-3">
                  <div className={`w-3 h-3 rounded-full ${doctor.isAvailable ? 'bg-green-500' : 'bg-red-500'} border-2 border-white shadow-sm`} />
                </div>
              ...
              <div className="p-4">
                ...
                <div className="mb-4">
                  <div className="flex items-center gap-2 text-xs">
                    ...
                    <span className={`font-medium ${doctor.isAvailable ? 'text-green-600' : 'text-orange-600'}`}>
                      {doctor.nextSlot}
                    </span>
                  </div>
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    className="flex-1 text-xs border-primary/20 hover:border-primary/40 hover:bg-primary/5 text-primary"
                  >
