            ...
            {!showRegistrationForm ? (
              <div className="space-y-4">
                <form onSubmit={handleProceedToForm} className="space-y-4">
                  {/* Mobile Block — switches layout once verified */}
                  {isPhoneVerified ? (
                    /* ── Post-verification: clean row matching mockup ── */
                  ...
                  {isOtpLoading ? (
                    ...
                    <div className="space-y-1.5">
                      <div className="flex justify-between items-center">
                        ...
                        {!isPhoneOtpSent && mobileNo.length < 10 && (
                          <span className="text-[10px] font-normal text-gray-400">OTP sends automatically</span>
                        )}
                      </div>
                      ...
                      <Input
                        ...
                        className="w-full h-11 px-3.5 text-base font-semibold bg-gray-50 border border-gray-300 rounded-lg focus:outline-none  transition-all"
                      />
