...
export default function CartPage() {
  ...
  const handleProceedToCheckout = () => {
    ...
    // Prepare data for checkout page as it expects it
    // The checkout page looks for 'buyNowProduct' and 'cartItems' in localStorage

    let checkoutData;
    if (cartItems.length === 1) {
      // Single unique item in cart - pass its actual details
                  ...
                  {cartItems.map((item: any) => (
                    ...
                    >
                      ...
                      <div className="flex-grow ml-4 lg:ml-6">
                        ...
                        <div className="flex items-center gap-1 mb-2 text-muted-foreground" title={`Sold by ${item.supplierName || item.vendorName || "GlowVita Partner"}`}>
