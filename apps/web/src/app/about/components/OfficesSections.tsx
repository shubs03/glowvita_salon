    ...
    <section className="py-10 px-6 lg:px-8 max-w-7xl mx-auto bg-background">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {offices.map((office, index) => (
          <div
            key={index}
            className="bg-card border border-border rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 group hover:border-primary/50"
          >
            {/* Header Section */}
