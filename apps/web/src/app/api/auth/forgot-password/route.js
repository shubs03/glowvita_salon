...
export async function POST(request) {
  try {
    ...
    // In case there is an env var override like NEXT_PUBLIC_WEB_URL
    const overrideUrl = NEXT_PUBLIC_WEB_URL || process.env.NEXT_PUBLIC_APP_URL || process.env.NEXT_PUBLIC_WEB_URL;
    if (overrideUrl) {
