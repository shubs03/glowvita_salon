...
export function ProductCard({ 
  ...
  const handleClick = (e: React.MouseEvent) => {
    // Prevent click event from buttons/links from triggering navigation
  ...
  return (
    <div className="inter-var cursor-pointer" onClick={handleClick}>
      <CardContainer className="h-full">
        <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[20rem] h-full rounded-lg p-6 border overflow-hidden">
