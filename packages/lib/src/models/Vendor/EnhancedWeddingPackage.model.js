...
const enhancedWeddingPackageSchema = new mongoose.Schema({
  name: {
    type: String,
    required: true,
    trim: true,
...
enhancedWeddingPackageSchema.pre("save", function (next) {
  this.updatedAt = Date.now();
  next();
});

// Add method to calculate package price with all customizations
enhancedWeddingPackageSchema.methods.calculateCustomizedPrice = function(customizedServices = null) {
...
enhancedWeddingPackageSchema.methods.calculateCustomizedDuration = function(customizedServices = null) {
  const servicesToCalculate = customizedServices || this.services;
...
enhancedWeddingPackageSchema.methods.validateCustomization = function(customizedServices) {
...
enhancedWeddingPackageSchema.methods.populateEnhancedServiceDetails = async function() {
...
enhancedWeddingPackageSchema.methods.applyCustomizations = function(customizedServices) {
...
enhancedWeddingPackageSchema.methods.getDepositAmount = function() {
...
const EnhancedWeddingPackageModel =
  mongoose.models.EnhancedWeddingPackage || mongoose.model("EnhancedWeddingPackage", enhancedWeddingPackageSchema);

export default EnhancedWeddingPackageModel;